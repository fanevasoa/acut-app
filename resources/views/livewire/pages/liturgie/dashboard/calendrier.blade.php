<div>
    ...
    <div class="py-5 text-center text-4xl font-bold text-gray-600">
        Calendrier
    </div>
        ...
        <div class="w-5/6">
            <div class="grid grid-cols-6 space-x-8">
                <x-datetime-picker label="Date de début" placeholder="Date de début" without-timezone without-time
                    wire:model.live="filters.minDate" display-format="dddd DD MMMM YYYY " />
                <x-datetime-picker label="Date de fin" placeholder="Date de fin" without-timezone without-time
                    wire:model.live="filters.maxDate" display-format="dddd DD MMMM YYYY " />
            </div>

            <table class="my-6 w-full rounded-lg bg-white p-2 shadow-lg">
                <thead>
