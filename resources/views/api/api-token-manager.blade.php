<div>
    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-input-lc id="name" type="text" class="mt-1 block w-full" wire:model="createApiTokenForm.name" autofocus />
    ...
    <x-dialog-modal wire:model.live="displayingToken">
        ...
        <x-slot name="content">
            ...
            <x-input-lc x-ref="plaintextToken" type="text" readonly :value="$plainTextToken"
    ...
    <x-dialog-modal wire:model.live="managingApiTokenPermissions">
        ...
        <x-slot name="footer">
            ...
            <x-button-lc class="ml-3" wire:click="updateApiToken" wire:loading.attr="disabled">
                {{ __('Save') }}
            </x-button-lc>
        </x-slot>
    </x-dialog-modal>
